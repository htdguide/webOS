...
function HalfLife({ onClose: parentOnClose }) {
  ...
  useEffect(() => {
    ...
    const iframeUrl =
      '/WebintoshHD/Applications/Half-Life/xash.html?cb=' +
      Date.now();

    // open draggable window once
    const windowId = openDraggableWindow({
      id: 'HalfLife',            // stable id to dedupe in StrictMode
      title: 'Half-Life',
      windowWidth,
      windowHeight,
      minWindowWidth,
